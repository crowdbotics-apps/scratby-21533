"""scratby_21533 URL Configuration
...
admin.site.site_header = "scratby"
admin.site.site_title = "scratby Admin Portal"
admin.site.index_title = "scratby Admin"

# swagger
api_info = openapi.Info(
    title="scratby API",
    default_version="v1",
    description="API documentation for scratby App",
)
